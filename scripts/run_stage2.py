...
def main():
    ...
    print(f"Running Stage 2 optimization ({args.optimizer})...", flush=True)
    result, best_params = run_stage2(baseline, weights=weights, normalization=normalization, optimizer=optimizer, progress_cb=_print_progress)
